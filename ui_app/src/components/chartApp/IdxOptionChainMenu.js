...
import { idxOptionChainChartAction } from '../../actions/ChartActions';
...
const IdxOptionChainMenu = (props) => {
  ...
  const getData = () => {
    ...
    dispatch(idxOptionChainChartAction(symbol, optExpDate, selectedDate));
  }
    ...
    return (
        <ExpansionPanel className={classes.panel}>
          ...
          <ExpansionPanelSummary
            ...
            id="panel1a-header"
          >
          <Typography variant='body2'>Index OptionChain</Typography>
          </ExpansionPanelSummary>
            ...
            <ExpansionPanelDetails>
              <FormControl className={classes.formControl}>
                ...
                <Typography variant='button'>Get Data</Typography>
                </Button>
              </FormControl>
            </ExpansionPanelDetails>
...
export default IdxOptionChainMenu;