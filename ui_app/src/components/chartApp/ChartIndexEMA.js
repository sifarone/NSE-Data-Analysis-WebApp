...
export default class ChartIndexEMA extends React.Component {
    constructor(props) {
        super(props)
                ...
                data={{
                    ...
                    datasets: [
                        ...
                        },
                        {
                            ...
                            data: calculateEMA(5, this.props.cdata.closingValue),
                            yAxisID : 'y-axis-1'
                        },
                        {
                            type: 'line',
                            ...
                            data: calculateEMA(9, this.props.cdata.closingValue),
                            yAxisID : 'y-axis-1'
                        },
                        {
                            type: 'line',
                            ...
                            data: calculateEMA(14, this.props.cdata.closingValue),
                            yAxisID : 'y-axis-1'
                        },
                        {
                            type: 'line',
                            ...
                            data: calculateEMA(20, this.props.cdata.closingValue),
                            yAxisID : 'y-axis-1'
                        }
                    ]
